function Br_fading= SEMI_spec_chan_derive_mag(~,phase,delay,DOA_Phi,DOA_Theta,position_elements_nor,L,N,M,Nt)
        ...
        for nn = 1: N
            for mm = 1 : M
                for l = 1 : L
                    ...
                    Br_fading_tmp(nn,mm,l,jj)= exp(1i * phase(nn,mm,jj)) * sinc((l-1)-delay(nn,mm,jj)) ...
