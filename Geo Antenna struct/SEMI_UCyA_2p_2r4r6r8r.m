...
for Nr_ULA=2:2:8 
    fprintf('Working at Nr_ULA: %d elements.\n', Nr_ULA);
    G = [];
    %% Derivative
    ...
    CRB_op_r=[CRB_op_r;CRB_op];
    CRB_op_spec_r=[CRB_op_spec_r;CRB_op_spec];
    CRB_SB_1_r=[CRB_SB_1_r;CRB_SB_1];
    CRB_SB_2_r=[CRB_SB_2_r;CRB_SB_2];
    CRB_SB_3_r=[CRB_SB_3_r;CRB_SB_3]; 
    CRB_SB_spec_1_r=[CRB_SB_spec_1_r;CRB_SB_spec_1]; 
    CRB_SB_spec_2_r=[CRB_SB_spec_2_r;CRB_SB_spec_2];   
    CRB_SB_spec_3_r=[CRB_SB_spec_3_r;CRB_SB_spec_3];  
end
%figure
