...
%% figure
h = figure();
semilogy(SNR, CRB_SB_ULA, '-b', 'LineWidth', 1.5, 'Color', '#7E2F8E');
hold on;
% semilogy(SNR, CRB_SB_UCyA, '*', 'LineWidth', 1.5, 'Color', "#0072BD", 'MarkerSize', 7);
semilogy(SNR, CRB_SB_ULA_spec, '-g o', 'LineWidth', 1.5, 'Color', "#0072BD", 'MarkerFaceColor', "#FFFF00");
semilogy(SNR, CRB_SB_UCyA_spec, '-r d', 'LineWidth', 1.5, 'Color', "#FF0000", 'MarkerFaceColor', "#FFFF00");
