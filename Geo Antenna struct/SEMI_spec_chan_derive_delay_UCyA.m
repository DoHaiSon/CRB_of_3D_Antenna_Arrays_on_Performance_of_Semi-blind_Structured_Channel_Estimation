function Br_delay= SEMI_spec_chan_derive_delay_UCyA(fading,delay,DOA_Phi,DOA_Theta,position_elements_nor,L,M,Nt,fc)
...
for jj = 1 : Nt
    for mm = 1 : M
        for l = 1 : L
            ...
            Br_delay_tmp(mm,l,jj)=fading(mm,jj) ...
                *exp(-1i*2*pi*fc*delay(mm,jj))* ...
                    (-1i*2*pi*fc*sinc((l-1)-delay(mm, jj))* ...
